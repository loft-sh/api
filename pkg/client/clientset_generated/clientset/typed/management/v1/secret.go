...
type SecretInterface interface {
	...
	UpdateStatus(ctx context.Context, secret *v1.Secret, opts metav1.UpdateOptions) (*v1.Secret, error)
...
func newSecrets(c *ManagementV1Client) *secrets {
	return &secrets{
		client: c.RESTClient(),
	}
}
...
func (c *secrets) UpdateStatus(ctx context.Context, secret *v1.Secret, opts metav1.UpdateOptions) (result *v1.Secret, err error) {
	result = &v1.Secret{}
	err = c.client.Put().
		Resource("secrets").
		Name(secret.Name).
