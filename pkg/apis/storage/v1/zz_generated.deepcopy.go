...
func (in *NodeProviderTerraform) DeepCopyInto(out *NodeProviderTerraform) {
	*out = *in
	if in.NodeTemplate != nil {
		...
		*out = new(TerraformTemplateSource)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TerraformTemplateSource) DeepCopyInto(out *TerraformTemplateSource) {
	*out = *in
	if in.Git != nil {
		in, out := &in.Git, &out.Git
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TerraformTemplateSource.
func (in *TerraformTemplateSource) DeepCopy() *TerraformTemplateSource {
	if in == nil {
		return nil
	}
	out := new(TerraformTemplateSource)
