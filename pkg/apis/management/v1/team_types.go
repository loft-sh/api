...
// +genclient:method=ListClusters,verb=get,subresource=clusters,result=github.com/loft-sh/api/v2/pkg/apis/management/v1.TeamClusters
// +genclient:method=ListAccessKeys,verb=get,subresource=accesskeys,result=github.com/loft-sh/api/v2/pkg/apis/management/v1.TeamAccessKeys
