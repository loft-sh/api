...
type ArgoCDApplicationInformer interface {
	...
	Lister() storagev1.ArgoCDApplicationLister
}
...
func (f *argoCDApplicationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisstoragev1.ArgoCDApplication{}, f.defaultInformer)
}

func (f *argoCDApplicationInformer) Lister() storagev1.ArgoCDApplicationLister {
	return storagev1.NewArgoCDApplicationLister(f.Informer().GetIndexer())
}
