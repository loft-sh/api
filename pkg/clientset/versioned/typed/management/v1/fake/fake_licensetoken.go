...
func (c *FakeLicenseTokens) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.LicenseToken, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(licensetokensResource, name), &v1.LicenseToken{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeLicenseTokens) List(ctx context.Context, opts metav1.ListOptions) (result *v1.LicenseTokenList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(licensetokensResource, licensetokensKind, opts), &v1.LicenseTokenList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeLicenseTokens) Create(ctx context.Context, licenseToken *v1.LicenseToken, opts metav1.CreateOptions) (result *v1.LicenseToken, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(licensetokensResource, licenseToken), &v1.LicenseToken{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1.LicenseToken), err
...
func (c *FakeLicenseTokens) Update(ctx context.Context, licenseToken *v1.LicenseToken, opts metav1.UpdateOptions) (result *v1.LicenseToken, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(licensetokensResource, licenseToken), &v1.LicenseToken{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1.LicenseToken), err
...
func (c *FakeLicenseTokens) UpdateStatus(ctx context.Context, licenseToken *v1.LicenseToken, opts metav1.UpdateOptions) (*v1.LicenseToken, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(licensetokensResource, "status", licenseToken), &v1.LicenseToken{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1.LicenseToken), err
...
func (c *FakeLicenseTokens) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.LicenseToken, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(licensetokensResource, name, pt, data, subresources...), &v1.LicenseToken{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1.LicenseToken), err
